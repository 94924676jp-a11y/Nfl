...
Run `caa597a936ea45d4`, candidate `V1_CANDIDATE_R9_W1P_G`, 1,000 draws,
DET at BUF, 2026 week 2. Every figure below is measured from that sealed
...
## Jahmyr Gibbs — 23.37 carries, 101.0 rushing yards
...
| 2 | Detroit's quarterbacks take **7.19%** — scrambles 0.90, designed 0.56, kneels 0.64 | A1 multinomial over the rush-play budget, **historical prior** per team. Goff is not a rushing quarterback and the split says so |
...
| 5 | **101.0 yards** (p10 47, p50 97, p90 160) | emp_tilt system A, RB stratum, **every carry drawn individually**. Realised 4.3212 yd/carry against a pool mean of 4.2902 |

Gibbs' P(zero carries) is **0.008**, and 0.007 of that is worlds where he is
absent from the game entirely.

## James Cook — 10.56 carries, 45.65 rushing yards

| Step | Quantity | Where it comes from |
|---|---|---|
| 1 | Team rush budget **30.08** (sd 6.87, p10 21, p90 38) | D1, **historical prior**. Buffalo's is slightly LARGER than Detroit's |
| 2 | Buffalo's quarterbacks take **23.25%** — scrambles 2.53, designed 2.90, kneels 1.56 | A1, **historical prior**. This is Josh Allen and it is football-correct |
...
| 5 | **45.65 yards** (p10 0, p50 39, p90 99) | same conversion. Realised 4.3242 yd/carry |
